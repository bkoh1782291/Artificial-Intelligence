...
# Assume that Player1 (X) starts first
        ...
        for i in range(3) :
            for j in range(3) :
                ...
                if (b[i][j] == '-') :
                    ...
                    # # load moves into output file
                    # file = open(sys.argv[2], "a")
                    # file.write(str_x + " " + str(best) + '\n')
        ...
        for i in range(3) :
            for j in range(3) :
                ...
                if (b[i][j] == '-') :
                    ...
                    #     # load moves into output file
                    #     file = open(sys.argv[2], "a")
                    #     file.write(str_o + " " + str(EvaluateBoard(b)) + '\n')
...
# function to display all possible game states
# def gameStates(b):
...
if __name__ == "__main__":
    ...
    # if no games to play, print nothing
    ...
    # check the state of the board after next best move
    check_board = EvaluateBoard(b)

    # print "check_board: " + str(check_board)
    print new_str
    ...
    file.write(new_str + " " + str(check_board) + '\n')
